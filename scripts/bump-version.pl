...
Updating version number and release date of the Archive::ByteBoozer package:
...
$command = sprintf q{sed -i -e "s/Archive::ByteBoozer Version [0-9]\\+\\.[0-9]\\+/Archive::ByteBoozer Version %s/" README}, $new_version;
